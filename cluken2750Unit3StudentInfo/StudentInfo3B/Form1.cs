...
namespace StudentInfo3B
{
    public partial class Form1 : Form
    {
        ...
        {// sequence diagram using combo boxes with bound objects + dbContext
            ...
            // we want the department ^^ id of the course, to pass the departmentId of the selected department. (Above)
            this.coursesDropDownList.DisplayMember = "CourseTitle";
